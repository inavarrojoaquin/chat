 ...
 * @author Febo
 */
public class DeleteEnableUserPolicyAction extends Action{

    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        System.out.println("DeleteEnableUserPolicyAction:execute");
        
        String policyId = (String) this.getForm().getItem("policyId");
        
        Logger.getLogger(getClass().getName()).log(Level.INFO, "DeleteEnableUserPolicyAction-Param: {0}", policyId);

        Client client = ClientBuilder.newClient();

        Logger.getLogger(getClass().getName()).log(Level.INFO, "DeleteEnableUserPolicyAction-PRE llamado a POLICY");
        /**Delete policy by policyId*/
        Form policyForm = new Form();
        policyForm.param("policyId", policyId);
        
        WebTarget policyTarget = client.target("http://localhost:8080/chat/webresources/roomaccesspolicy/delete/policy/id");        
        ...
        System.out.println("POLICY ID DELETE SECCESSFULL");
    }
